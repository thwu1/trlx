...
class P3OConfig(MethodConfig):
    ...
    def loss(
        ...
        loss1_clip = -q_diff * cliped_ratio_old.detach() * torch.clamp(logratio[0] - logratio[1], old_logratio[0] - old_logratio[1] - self.cliprange, old_logratio[0] - old_logratio[1] + self.cliprange) / 2
